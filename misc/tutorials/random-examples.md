...
./prank.sh eval-predict ../p2rank-datasets/coach420.ds -l default \
    -fail_fast 1 \
    -visualizations 0       
./prank.sh eval-predict ../p2rank-datasets/holo4k.ds -l default \
    -fail_fast 1 \
    -visualizations 0   
./prank.sh eval-predict ../p2rank-datasets/joined.ds -l default \
    -fail_fast 1 \
    -visualizations 0   
