 ...
 * @see cz.siret.prank.program.routines.analyze.AnalyzeRoutine#cmdAaPropensities()
 */
@Slf4j
@CompileStatic
class AaPropensityFeature extends ResidueFeatureCalculator implements Parametrized {
...
//===========================================================================================================//
    ...
    double calculatePropensityForResidue(@Nullable Residue res) {
        String code = res.getCorrectedCode()
