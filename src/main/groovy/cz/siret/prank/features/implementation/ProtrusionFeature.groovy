...
class ProtrusionFeature extends SasFeatureCalculator implements Parametrized {
    ...
    double[] calculateForSasPoint(Atom sasPoint, SasFeatureCalculationContext context) {
        ...
        double protAtoms = context.extractor.deepSurrounding.cutoffAroundAtom(sasPoint, params.protrusion_radius).count  // deepSurrounding is previously generated in ChemFeatureExtractor, depth is params.protrusion_radius
