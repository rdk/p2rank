 ...
 */
@CompileStatic
class ZConservCloud2SF extends SasFeatureCalculator implements Parametrized {

    final List<String> HEADER = ['mean', 'sum', 'vpa']

    @Override
    String getName() {
        return 'z-conserv_cloud2'
    }
    ...
    double[] calculateForSasPoint(Atom sasPoint, SasFeatureCalculationContext context) {
        ...
        List<Double> scores = exp_residues.collect {
            double score = ZConservRF.getZScoreForResidue(it, context.protein)
